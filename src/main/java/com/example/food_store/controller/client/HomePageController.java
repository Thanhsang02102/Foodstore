...
public class HomePageController extends BaseController {
    ...
    public String handleRegister(@ModelAttribute("userDTO") @Valid RegisterDTO userDTO, BindingResult bindingResult,
            @RequestParam("OTP_check") String OTP, Model model) {
        log.info("Request to /register");
    ...
    public String getVerifyPage(@ModelAttribute("registerUser") @Valid RegisterDTO userDTO, BindingResult bindingResult,
        ...
        EmailRequest emailRequest = new EmailRequest(email, "Xác nhận đăng ký",
    ...
    public String postMethodName(Model model, @ModelAttribute("newUser") User thanhsang, BindingResult newBindingResult,
