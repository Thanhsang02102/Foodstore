...
public class UserController extends BaseController {
    ...
    public String createUser(Model model, @ModelAttribute("newUser") @Valid User thanhsang,
        ...
        if (newBindingResult.hasErrors() || this.userService.checkEmailExist(thanhsang.getEmail())) {
            if (this.userService.checkEmailExist(thanhsang.getEmail()))
    ...
    public String sendRequestToMail(@RequestParam("email") String email) {
        ...
        EmailRequest emailRequest = new EmailRequest(email, "Xác nhận khôi phục mật khẩu",
