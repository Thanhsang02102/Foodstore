                                            ...
                                            <div class="col-12" id="targetFilter">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-1"
                                                        value="Giảm cân">
                                                    <label class="form-check-label" for="target-1">Giảm cân</label>
                                                </div>

                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-2"
                                                        value="Tập gym">
                                                    <label class="form-check-label" for="target-2">Tập gym</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-3"
                                                        value="Tốt cho tim mạch">
                                                    <label class="form-check-label" for="target-3">Tốt cho tim
                                                        mạch</label>
                                                </div>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-4"
                                                        value="Tốt cho xương">
                                                    <label class="form-check-label" for="target-4">Tốt cho xương</label>
                                                </div>

                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-5"
                                                        value="Tốt cho mắt">
                                                    <label class="form-check-label" for="target-5">Tốt cho mắt</label>
                                                </div>

                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-6"
                                                        value="Tốt cho não bộ">
                                                    <label class="form-check-label" for="target-6">Tốt cho não
                                                        bộ</label>
                                                </div>

                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-7"
                                                        value="Tăng cường miễn dịch">
                                                    <label class="form-check-label" for="target-7">Tăng cường miễn
                                                        dịch</label>
                                                </div>

                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-8"
                                                        value="Bổ sung dinh dưỡng">
                                                    <label class="form-check-label" for="target-8">Bổ sung dinh
                                                        dưỡng</label>
                                                </div>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-9"
                                                        value="Làm đẹp">
                                                    <label class="form-check-label" for="target-9">Làm đẹp</label>
                                                </div>

                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-10"
                                                        value="Tốt cho tiêu hóa">
                                                    <label class="form-check-label" for="target-10">Tốt cho tiêu
                                                        hóa</label>
                                                </div>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-11"
                                                        value="Người lớn">
                                                    <label class="form-check-label" for="target-11">Người lớn</label>
                                                </div>

                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-12"
                                                        value="Trẻ em">
                                                    <label class="form-check-label" for="target-12">Trẻ em</label>
                                                </div>

                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-13"
                                                        value="Tất cả">
                                                    <label class="form-check-label" for="target-13">Tất cả</label>
                                                </div>

                                            </div>

                                            <div class="col-12" id="customertargetFilter">
                                                <div class="mb-2"><b>Đối tượng</b></div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="customertarget-1" value="Vận động viên">
                                                    <label class="form-check-label" for="customertarget-1">Vận động
                                                        viên</label>
                                                </div>

                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="customertarget-2" value="Người ăn kiêng">
                                                    <label class="form-check-label" for="customertarget-2">Người ăn
                                                        kiêng</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="customertarget-3" value="Người ăn chay">
                                                    <label class="form-check-label" for="customertarget-3">Người ăn
                                                        chay</label>
                                                </div>

                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="customertarget-4" value="Trẻ em">
                                                    <label class="form-check-label" for="customertarget-4">Trẻ
                                                        em</label>
                                                </div>

                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="customertarget-5" value="Người lớn">
                                                    <label class="form-check-label" for="customertarget-5">Người
                                                        lớn</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox"
                                                        id="customertarget-6" value="Tất cả">
                                                    <label class="form-check-label" for="customertarget-6">Tất
                                                        cả</label>
                                                </div>
                                        ...
                                        <div class="row g-4">
                                            ...
                                            <c:if test="${totalPages>0}">
                                                <div class="pagination d-flex justify-content-center mt-5">
                                                    ...
                                                    <li class="page-item">
                                                        <a class="${currentPage == 1 ? 'active page-link' : 'page-link'}"
