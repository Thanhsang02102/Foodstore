            ...
            <div class="row g-4">
              ...
              <div class="col-lg-3">
                <div class="d-flex justify-content-end pt-3">
                  <a target="_blank" class="btn btn-outline-secondary me-2 btn-md-square rounded-circle" href=""><i
                      class="fab fa-twitter"></i></a>
                  <a target="_blank" class="btn btn-outline-secondary me-2 btn-md-square rounded-circle"
                    href="https://www.facebook.com/profile.php?id=100041721947314&locale=vi_VN"><i
                      class="fab fa-facebook-f"></i></a>
                  <a target="_blank" class="btn btn-outline-secondary me-2 btn-md-square rounded-circle" href=""><i
                      class="fab fa-youtube"></i></a>
                  <a target="_blank" class="btn btn-outline-secondary btn-md-square rounded-circle" href=""><i
          ...
          <div class="row g-5">
            ...
            <div class="col-lg-4 col-md-6">
              <div class="footer-item">
                ...
                <p>Địa chỉ: 123 Đường ABC, Q. XYZ, TP. ABC</p>
                <p>Email: foodstore247official@gmail.com</p>
                <p>Số điện thoại: 0333333333</p>
